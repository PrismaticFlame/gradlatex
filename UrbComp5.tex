...
\begin{align}
    A = \sigma_1 u_1 v_1^T = 2 \sqrt{14} \cdot \frac{1}{14} \begin{bmatrix}
        1 \\ 2 \\ 3
    \end{bmatrix} \cdot \frac{1}{2} \begin{bmatrix}
        1 & 2 & 3
    \end{bmatrix} \\

    A = 2 \frac{1}{14} \begin{bmatrix}
        1 \\ 2 \\ 3
    \end{bmatrix} \cdot \frac{1}{2} \begin{bmatrix}
        1 & 2 & 3
    \end{bmatrix} \\
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{images/IMG_0165.jpeg}
    % \caption{}
    % \label{}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{images/IMG_0166.jpeg}
    % \caption{}
    % \label{}
\end{figure}
