...
\begin{figure}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}XX@{}}
        ...
        These models feature natural infection decline. In SIR and SEIR, individuals recover and the infection eventually ends. The SI model is debatable: while everyone becomes infected, one could argue that if everyone is infected, no one is truly ``infected'' in a meaningful sense.
        \\
    \end{tabularx}
\end{figure}
